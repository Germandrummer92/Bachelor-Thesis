...
\begin{flalign*}
		[ x:=0,y:=1, st:=0]& ((st = 0) \implies \\
			...
			\quad&\quad\cup (?(y<10 \vee y >10); x^{\prime}=1 \wedge y^{\prime}=1 \wedge y\leq10)) \\
			\quad&\cup (?(st=1); \\
			\quad&\quad(?(x=2); st:=2) \\
			\quad&\quad\cup(?(x<2\vee x>2);x^{\prime}=1, y^{\prime}=1 \wedge x\leq2)) \\
			\quad&\cup(?(st=2); \\
			\quad&\quad(?(y=5);x:=0;st:=3) \\
			\quad&\quad\cup(y>5\vee y<5); x^{\prime}=1,y^{\prime}=-2 \wedge y\geq5)) \\
			\quad&\cup(?(st=3); \\
			\quad&\quad(?(x=2);st:=0) \\
...
\subsection{The Remodelled Hybrid Program}
...
\begin{flalign*}
		tick > 2 &\implies \\
			&[ x:=tick,y:=1, valve:=1; \\
			\quad& (?(x=tick); new:=*; x:=0); \\
			\quad&(?(y+2*valve+tick*new\geq1\wedge y+2*valve+tick*new \leq 12 \wedge{} \\
			\quad&(new=1\vee new=2)); \\ 
			\quad&((?(new\neq valve); x^{\prime}=1, y^{\prime}=valve \wedge x \leq 2); \\
			\quad&\quad(\textrm{if } (x=2) \\
			\quad&\quad \textrm{then }valve:=new; x^{\prime} = 1, y^{\prime} = valve \wedge x \leq tick~\textrm{fi}) \\
